...
Hello! I'm **David Assef**, a developer passionate about creating **intuitive web and mobile applications**, with a special focus on integrating **Artificial Intelligence** to develop smarter and more efficient solutions.

My professional journey began at **Jingle Mágico**, where I transformed concepts into sound experiences. This unique background provided me with a different perspective on:
- 🎯 Creativity applied to technical problems
- 🔄 Quick adaptation to different contexts and needs
- 🤝 Efficiently translating client vision into impactful products

Today, I apply this same mindset to software development, using modern frameworks and AI tools to create robust, scalable, and user-centered applications.
...
I believe that a good developer needs inspiration and balance. When I'm not coding, you can find me:

- 🏄‍♂️ **Windsurfing** - Where I find new perspectives and learn about balance and adaptation
- 🎮 **Gaming** - Improving strategy and problem-solving skills in a fun way
